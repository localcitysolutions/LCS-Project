...
const DISTRICTS: District[] = [
  {
    ...
    arContent: {
      ...
      faq: [
        { q: "ما مدى تنافسية التسويق الرقمي في العليا مقارنة بأحياء الرياض الأخرى؟", a: "العليا هي الأكثر تنافسية في الرياض. تكاليف النقر على إعلانات قوقل قد تكون أعلى 3–5 أضعاف مقارنة بالأحياء الطرفية. النجاح يتطلب استهداف دقيق للجمهور ونقاط جودة قوية وسلطة SEO مبنية على مدى أشهر — لا حلول سريعة." },
  ...
  },
  {
    ...
    arContent: {
      ...
      faq: [
        ...
        { q: "كم يستغرق ظهور نتائج SEO في السليمانية؟", a: "عادةً 3–5 أشهر لتحسينات ترتيب عضوية ملموسة. إعلانات قوقل تجلب زياراً مؤهلاً خلال أيام من الإطلاق. نوصي بالجمع بين الاثنين للمكاسب السريعة والنمو طويل الأمد." },
      ],
  ...
  },
  {
    ...
    arContent: {
      ...
      faq: [
        ...
        { q: "هل في الروضة ملف محدد للعميل ينبغي استهدافه؟", a: "الشريحة الأساسية هي الأسر السعودية بعمر 25–55 بدخل متوسط إلى مرتفع. يقدّرون الجودة والثقة والانتماء المجتمعي. التسويق الصادق ذو الطابع المحلي يتفوق على الرسائل الرسمية المصقولة." },
      ],
  ...
  },
  {
    ...
    arContent: {
      ...
      about: [
        ...
        "الملف الديموغرافي يميل نحو الأسر السعودية الميسورة: أسر ذات دخلين ومهنيون شباب ورجال أعمال راسخون بعمر 25–50. متطورون رقمياً ويستخدمون إنستغرام وسناب شات بنشاط لاكتشاف مطاعم وخدمات جديدة، ويعتمدون على قوقل للتحقق من خياراتهم قبل الإنفاق.",
      ...
      faq: [
        ...
        { q: "ما منصات السوشيال الأهم في الملقا؟", a: "إنستغرام أساسي للمطاعم والكافيهات والعلامات الحياتية. سناب شات يصل للشريحة العمرية 18–35 من السعوديات بفاعلية عالية. تيك توك ينمو بسرعة للطعام والترفيه. للخدمات الطبية والمهنية يهيمن بحث قوقل." },
        { q: "كم ينبغي لمطعم في الملقا أن يخصص لميزانية التسويق الرقمي؟", a: "ميزانية بداية معقولة لمطعم في الملقا هي 3,000–5,000 ريال شهرياً موزعة على إعلانات قوقل وميتا/سناب. هذا المستوى يولد باستمرار حجوزات ومشتريات توصيل ملموسة عند تحسين الحملات بشكل صحيح." },
      ],
  ...
  },
  {
    ...
    arContent: {
      ...
      faq: [
        ...
        { q: "ما أهمية المراجعات للأعمال في حطين؟", a: "أهمية استثنائية. المستهلكون ذوو الثروات الضخمة في حطين يبحثون بعمق عن الأعمال قبل التعامل معها. نشاط لديه 50+ مراجعة خمس نجوم على قوقل وتعليقات إيجابية منتظمة له ميزة ثقة ضخمة أمام المنافسين ذوي الحضور الهزيل أو المختلط." },
  ...
  },
  {
    ...
    arContent: {
      ...
      faq: [
        { q: "ما أكثر شيء مؤثر يمكن لمشروع صغير في الصحافة فعله عبر الإنترنت؟", a: "استحق وحسّن ملف نشاطك في قوقل. مجاني تماماً، يؤثر مباشرة على ترتيبك في الخرائط، وسكان الصحافة يعتمدون بشكل كبير على خرائط قوقل لاكتشاف الخدمات المحلية. استثمار 15 دقيقة في الصور وساعات العمل والوصف يمكنه جلب عملاء لسنوات." },
        ...
        { q: "هل الإعلان الرقمي فعّال من حيث التكلفة للمشاريع الصغيرة في الصحافة؟", a: "نعم — خاصة مقارنة بأحياء وسط الرياض التي تكون تكاليف النقر فيها أعلى بكثير. سوق الإعلانات الأقل تنافسية في الصحافة يعني ميزانيات أصغر لا تزال قادرة على تحقيق نتائج ملموسة. 1,000–2,000 ريال شهرياً قد تكفي لبدء رؤية عائد حقيقي." },
      ],
  ...
  },
  {
    ...
    arContent: {
      ...
      faq: [
        ...
        { q: "ما أهمية خرائط قوقل لعيادة في الشفا؟", a: "بالغة الأهمية. المرضى عادةً يبحثون عن 'جراح عظام الرياض' أو 'عيادة أسنان بالقرب من الشفا' على خرائط قوقل قبل الحجز. عيادة لديها 100+ مراجعة وملف GBP محسّن تتمتع بميزة ثقة ضخمة أمام المنافسين ذوي الحضور الرقمي الضعيف." },
      ],
  ...
  },
  {
    ...
    arContent: {
      ...
      faq: [
        ...
        { q: "ما أكثر قناة رقمية فاعلية لنشاط جديد في النسيم؟", a: "ملف النشاط في قوقل مع SEO محلي أساسي للظهور العضوي الفوري، مدمجاً مع إعلانات سناب وإنستغرام المستهدفة لبناء وعي العلامة لدى الأغلبية دون 35. هذا التركيب يُقدّم عوائد فورية ومتراكمة." },
      ],
  ...
  },
  {
    ...
    arContent: {
      ...
      about: [
        ...
        "الشريط التجاري المتنامي على الشوارع الرئيسية لإشبيلية يشهد افتتاح مطاعم وكافيهات جديدة وعيادات خاصة وأعمال خدمية. المستهلكون في الحي شباب (متوسط العمر 25–35) ويعتمدون الجوال أولاً — يكتشفون ويبحثون ويقررون عبر الهاتف الذكي قبل الزيارة الشخصية.",
      ],
      ...
      faq: [
        ...
        { q: "ما مدى شباب سكان إشبيلية وكيف يؤثر ذلك على تسويقي؟", a: "متوسط السكان أصغر من الأحياء المركزية الأعرق — شريحة كبيرة هم أسر بأطفال دون 18 وأزواج شباب. هذا يعني المحتوى المحسّن للجوال والفيديو القصير (تيك توك وريلز) وإعلانات سناب شات هي الأكثر فاعلية." },
        { q: "هل يمكنني بدء التسويق الرقمي لمشروع صغير جداً في إشبيلية؟", a: "بالتأكيد. ملف النشاط في قوقل مجاني. SEO المحلي الأساسي يحتاج وقتاً أكثر من ميزانية. حملات قوقل صغيرة تبدأ من 500 ريال شهرياً يمكنها توليد حركة ملموسة. إشبيلية من أكثر أسواق الرياض سهولةً للتسويق الرقمي للمشاريع الصغيرة." },
      ],
  ...
  },
  {
    ...
    arContent: {
      ...
      faq: [
        ...
        { q: "هل الوقت الحالي مناسب للاستثمار في التسويق الرقمي لنشاط في الدرعية؟", a: "تماماً — هذا هو الوقت الأمثل. وجهة الدرعية لا تزال تبني سلطة SEO السياحية العضوية. الأعمال التي تستثمر في SEO والمحتوى التسويقي الآن ستمتلك تقدماً كبيراً مع تضاعف أعداد الزوار خلال 5–10 سنوات القادمة." },
