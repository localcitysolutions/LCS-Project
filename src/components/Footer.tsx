  ...
  return (
    <footer className="bg-[#050B15] border-t border-white/[0.06] pt-12 md:pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10 md:mb-14">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={s.label}
                  className="w-8 h-8 rounded-full bg-white/[0.05] flex items-center justify-center text-white/40 hover:text-[#F5C518] hover:bg-[#F5C518]/10 transition-all"
                >
                  <svg className="w-3.5 h-3.5" fill={s.label === "X" ? "currentColor" : "none"} stroke={s.label !== "X" ? "currentColor" : undefined} strokeWidth={s.label !== "X" ? 2 : undefined} viewBox="0 0 24 24">
                    <path strokeLinecap={s.label !== "X" ? "round" : undefined} strokeLinejoin={s.label !== "X" ? "round" : undefined} d={s.d} />
                  </svg>
                </a>
              ))}
              <a
                ...
                aria-label="WhatsApp"
                className="w-8 h-8 rounded-full bg-white/[0.05] flex items-center justify-center text-white/40 hover:text-[#25D366] hover:bg-[#25D366]/10 transition-all"
              >
            ...
            <a href="tel:+966564229190" className="inline-flex items-center gap-2 mt-4 text-white/40 hover:text-white text-xs transition-colors">
              <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span dir="ltr">+966 564 229 190</span>
            </a>
            <a href="mailto:hello@localcitysolutions.com" className="inline-flex items-center gap-2 mt-2 text-white/40 hover:text-white text-xs transition-colors">
              <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        {/* Bottom bar */}
        <div className={`border-t border-white/[0.06] pt-6 flex flex-col sm:flex-row items-center gap-3 ${isAr ? "sm:flex-row-reverse" : "sm:justify-between"}`}>
