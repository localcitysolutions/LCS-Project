...
export default function Footer({ locale }: FooterProps) {
  ...
  return (
    <footer
      dir={isAr ? "rtl" : "ltr"}
      className="bg-[#F2F6F4] border-t border-[#D8E4DF] pt-10 md:pt-16 pb-8"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-8 mb-8 md:mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href={isAr ? "/ar" : "/en"} className="text-[#14211F] font-bold text-lg tracking-tight">
              Local <span className="text-[#B89112]">City</span> Solutions
            </Link>
            <p className={`text-[#748781] text-xs leading-relaxed mt-2 max-w-xs ${isAr ? "text-right" : ""}`}>
              {tagline}
            </p>
            ...
            <div className={`flex items-center gap-2.5 mt-3 ${isAr ? "flex-row-reverse" : ""}`}>
              {[
                ...
                <a
                  ...
                  aria-label={s.label}
                  className="w-7 h-7 rounded-full bg-[#14211F]/[0.04] flex items-center justify-center text-[#748781] hover:text-[#B89112] hover:bg-[#B89112]/10 transition-all"
                >
                  <svg
                    className="w-3 h-3"
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-7 h-7 rounded-full bg-[#14211F]/[0.04] flex items-center justify-center text-[#748781] hover:text-[#25D366] hover:bg-[#25D366]/10 transition-all"
              >
            ...
            <div className="mt-3 space-y-1.5">
              <a
                ...
                className={`inline-flex items-center gap-1.5 text-[#748781] hover:text-[#14211F] text-xs transition-colors ${isAr ? "flex-row-reverse" : ""}`}
              >
          ...
          {/* Services */}
          <div>
            <h3 className={`text-[#14211F] font-bold text-sm mb-3 ${isAr ? "text-right" : ""}`}>
              ...
              {FOOTER_SERVICES.map((s) => (
                <li key={s.slug}>
                  <Link
                    ...
                    className={`text-[#748781] hover:text-[#14211F] text-xs transition-colors block ${isAr ? "text-right" : ""}`}
                  >
                    {L(s.label)}
                  </Link>
                </li>
        ...
        <div className="border-t border-[#D8E4DF] pt-8 mb-8">
          ...
          <ul className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-2 ${isAr ? "text-right" : ""}`}>
            {ALL_DISTRICTS.map((d) => (
              <li key={d.slug}>
                <Link
                  ...
                  className="text-[#748781] hover:text-[#14211F] text-xs transition-colors block"
                >
                  {L(d.name)}
                </Link>
              </li>
            ...
            <li>
              <Link
                href={`${p}/riyadh`}
                className="text-[#B89112]/60 hover:text-[#B89112] text-xs transition-colors block"
              >
        ...
        {/* Bottom bar */}
        <div className={`border-t border-[#D8E4DF] pt-5 flex flex-col sm:flex-row items-center gap-3 ${isAr ? "sm:flex-row-reverse" : "sm:justify-between"}`}>
          <p className="text-[#98A6A2] text-xs">{copyright}</p>
          <div className="flex items-center gap-4">
            {[
              ...
              <a key={l.label} href={l.href} className="text-[#98A6A2] hover:text-[#657872] text-xs transition-colors">
                {l.label}
              </a>
            ))}
          </div>
